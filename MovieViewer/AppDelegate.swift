...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.title = "In Theaters Now"
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "iconmonstr-video-8-72")
        ...
        comingSoonNavigationController.tabBarItem.image = UIImage(named: "iconmonstr-upload-11-72")
        
        
        
        let tabBarController = UITabBarController()
        
        tabBarController.viewControllers = [nowPlayingNavigationController, comingSoonNavigationController]
